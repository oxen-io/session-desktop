...
// import { existingUser, openAppsNoNewUsers } from './setup/new_user';
...
// test('Linked Device with existing user', async () => {
//   // Open two windows
...
//   // // Check session ID
//   // expect(await windowA1.innerText('[data-testid=your-session-id]')).toBe(sessionIDTest);
//   // // Exit profile module
//   // await windowA1.click('.session-icon-button.small');
