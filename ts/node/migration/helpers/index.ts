...
Any helper functions that are exported from a helper file must have run
verify(version, targetVersion); on the first line to confirm that the helper function is being reference within the correct migration. It will throw an error otherwise.
